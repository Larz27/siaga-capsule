// frontend/src/components/FormFlow.tsx
    ...
    switch (currentStep) {
      ...
      case 2:
        return (
          ...
          (!formData.obstacles.includes("Other") ||
            formData.otherObstacle.trim().length > 0)
        );
      case 3:
      ...
      case 5:
        return (
          ...
          (!formData.occupationStatus.includes("Other") ||
            formData.otherOccupation.trim().length > 0) &&
          (!formData.sectorInterest.includes("Other") ||
            formData.otherSector.trim().length > 0)
        );
      case 6:
        return true;
      default:
            ...
            <div className="space-y-6">
              <div className="text-center space-y-4">
                <h2 className="text-2xl font-bold text-gray-800">
                  If you had the freedom, support, and resources to start
                  anything — what would you do?
                </h2>
                <p className="text-gray-600">
                  Share something you'd like to try, change, create, or explore
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-3">
                {VALUES_OPTIONS.map((value) => (
                  ...
                  >
                    <div className="flex items-center space-x-2">
                      <Checkbox checked={formData.values.includes(value)} />
                      <Label className="cursor-pointer font-medium">
                        {value}
                      </Label>
                    </div>
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, otherValue: e.target.value })
                  }
                  className="bg-white/80 border-purple-200/50 focus:border-purple-400"
                />
              </div>
          ...
          {currentStep === 4 && (
            <div className="space-y-6">
              <div className="text-center space-y-4">
                ...
                <p className="text-gray-600">
                  We'll use this email to deliver your time capsule message and
                  send you a digital keepsake now.
                </p>
              </div>
              <div className="space-y-2">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <Label className="flex items-center gap-2">
                    <User className="w-4 h-4 text-purple-600" /> Age
                  </Label>
                  <Input
                    type="number"
                    placeholder="25"
                ...
                <div className="space-y-2">
                  <Label className="flex items-center gap-2">
                    <MapPin className="w-4 h-4 text-purple-600" /> District
                  </Label>
                  <Select
                    onValueChange={(value) =>
